            ...
            onPressed: () async {
              ...
              if (cart.numItems > 0) {
                for (var element in cart.items) {
                  textToShare =
                      '$textToShare${element.productId}|${element.purchased}${element.purchased > 1 ? ' ${element.idUnit}s.' : ' ${element.idUnit}.'}|${element.productName}\n';
                }
                    ...
                    children: [
                          ...
                          child: Container(
                            ...
                            child: AspectRatio(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    '$SERVER_IP$IMAGES_DIRECTORY${cart.getItem(index).productCode}_0.gif',
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    cart.getItem(index).quantityMaxPrice !=
                                            999999
                                        ? IconButton(
                                            icon: Image.asset(
                      ...
                      Expanded(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                (cart.getItem(index).purchased > 1)
                                    ? '${cart.getItem(index).purchased} ${cart.getItem(index).idUnit}s.'
                                    : '${cart.getItem(index).purchased} ${cart.getItem(index).idUnit}.',
                                style: const TextStyle(
        ...
        return SafeArea(
          child: Container(
            height: (constraints.maxWidth > 1200)
                ? (constraints.maxHeight ~/ 6).toDouble()
                : (constraints.maxHeight ~/ 8).toDouble(),
            decoration: const BoxDecoration(
                border: Border(top: BorderSide(color: tanteLadenBrown500))),
            child: Column(
              children: [
                Expanded(
                  flex: 1,
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              IconButton(
                                ...
                                iconSize: 6.0,
                                onPressed: () {
                                  var widgetImage = Image.asset(
                                      'assets/images/weightMessage.png');
                                  var message =
                                  ...
                                  DisplayDialog.displayDialog(context,
                                      widgetImage, 'Total aproximado', message);
                                },
                              )
                            ],
                          ),
                                ...
                                onTap: () async {
                                  try {
                                    ...
                                    if (token == '') {
                                      ...
                                      Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (context) =>
                                                  (const LoginView(
                                                      reason:
                                                          COME_FROM_ANOTHER)) //  1 the call comes from the drawer. 2 the call comes from cart.view.dart
                                              ));
                                    } else {
                                      // login yet done
                                      // test if the user has an address
                                      debugPrint(
                                          'Estoy en el else de login yet done');
                                      Map<String, dynamic> payload;
                                      payload = json.decode(utf8.decode(
                                      ...
                                      _showPleaseWait(true);
                                      debugPrint(
                                          'El user_id es: ${payload['user_id']}');
                                      final Uri url = Uri.parse(
                                          '$SERVER_IP/getDefaultLogisticAddress/${payload['user_id']}');
