...
class ConfirmPurchaseView extends StatelessWidget {
  const ConfirmPurchaseView(
      this.resultListAddress, this.phoneNumber, this.userId,
      {super.key});
...
class _SmallScreenViewState extends State<_SmallScreenView> {
  ...
  void _badStatusCode(http.Response response) {
        ...
        if (element.getIndexElementAmongQuantity() == -1) {
          final item = ProductAvail(
              ...
              discountAmount: (element.discountAmount *
                  -1), // Save a negative amount because it is a discount
          ...
          final item = ProductAvail(
              ...
              purchased: element
                  .purchased, // The quantity purchased is in the father product field
              ...
              productPriceDiscounted:
                  element.items[index].productPriceDiscounted,
      ...
      final http.Response res = await http
          .post(url,
              ...
              body: jsonEncode(<String, dynamic>{
                'purchased_products':
                    productAvailListToSave.map<Map<String, dynamic>>((e) {
                  return {
  ...
  Widget build(BuildContext context) {
    ...
    final Widget tmpBuilder = GestureDetector(
      child: Container(
        ...
        child: const Text(
          'Tramitar pedido',
          style: TextStyle(fontSize: 24.0, color: tanteLadenBackgroundWhite),
        ),
      ),
      onTap: () async {
        try {
          ...
          await DisplayDialog.displayDialog(
              context, widgetImage, 'Compra realizada', message);
          cart.removeCart();
          if (!context.mounted) return;
      ...
      children: <Widget>[
        ...
        Card(
          ...
          child: ListTile(
            ...
            title: (widget.phoneNumber == "null")
                ? // Come "null" from shared_preferences and from backend if there no is a value
                const Text(
                    'Añadir teléfono',
                    style: TextStyle(
                      fontWeight: FontWeight.bold,
                ...
                IconButton(
                    ...
                    onPressed: () async {
                      var retorno = await Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) =>
                                  (AddPhone(_phoneNumber, widget.userId))));
                      setState(() {
                      ...
                      var retorno = await Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) => (AddPhone(
                                  widget.phoneNumber, widget.userId))));
                      setState(() {
                        _phoneNumber = retorno;
                      });
                    },
                    ...
                    SizedBox(
                      ...
                      child: IconButton(
                        ...
                        onPressed: () {
                          ...
                          var message =
                              'En los productos al peso, el importe se ajustará a la cantidad servida. El cobro del importe final se realizará tras la presentación de tu pedido.';
                          DisplayDialog.displayDialog(context, widgetImage,
                              'Total aproximado', message);
                        },
                      ),
                    )
                  ],
            ...
            Expanded(
                ...
                child: Text(
                  NumberFormat.currency(
                      ...
                      .format((cart.totalPrice / MULTIPLYING_FACTOR)),
                  style: const TextStyle(
                    fontWeight: FontWeight.bold,
                    fontSize: 20.0,
                    fontFamily: 'SF Pro Display',
          ...
          children: [
            ...
            Expanded(
                ...
                child: Text(
                  NumberFormat.currency(
                          locale: 'es_ES', symbol: '€', decimalDigits: 2)
                      .format((cart.totalTax / MULTIPLYING_FACTOR)),
                  style: const TextStyle(
                    fontWeight: FontWeight.bold,
                    fontSize: 20.0,
                    fontFamily: 'SF Pro Display',
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        ...
                        DisplayDialog.displayDialog(
                            context, widgetImage, 'Total aproximado', message);
                      },
                    )
                  ],
                )),
