...
import 'package:kompras/model/NewProductData.model.dart';
import 'package:kompras/model/PriceChangeType.model.dart';
import 'package:kompras/model/ProductType.model.dart';
import 'package:kompras/model/ProviderProduct.model.dart';
import 'package:kompras/model/TaxType.model.dart';
import 'package:kompras/model/UnitType.model.dart';
import 'package:kompras/service/NewProduct.service.dart';
...
class _SmallScreenView extends StatefulWidget {
  ...
  const _SmallScreenView(this.data, this.service);
  @override
...
class _SmallScreenViewState extends State<_SmallScreenView> {
  ...
  final TextEditingController _valueDiscountController =
  ...
  final TextEditingController _quantityMinPriceController =
      TextEditingController();
  final TextEditingController _quantityMaxPriceController =
      TextEditingController();
  // vars
  ...
  void _productPriceControllerProcessor() {
    _productPrice = double.tryParse(
        _productPriceController.text.replaceAll(RegExp(','), '.'))!;
  }

  void _valueDiscountControllerProcessor() {
    _valueDiscount = double.tryParse(
        _valueDiscountController.text.replaceAll(RegExp(','), '.'))!;
  }

  void _percentDiscountControllerProcessor() {
    _percentDiscount = double.tryParse(
        _percentDiscountController.text.replaceAll(RegExp(','), '.'))!;
  }
  ...
  void initState() {
    ...
    _productPriceController.text =
        NumberFormat('##0.00', 'es_ES').format(double.parse((0.00).toString()));
    _productPriceController.addListener(_productPriceControllerProcessor);
    _valueDiscountController.text =
        NumberFormat('##0.00', 'es_ES').format(double.parse((0.00).toString()));
    ...
    _quantityMinPriceController
        .addListener(_quantityMinPriceControllerProcessor);
    _quantityMaxPriceController.text = _quantityMaxPrice.toString();
    _quantityMaxPriceController
        .addListener(_quantityMaxPriceControllerProcessor);
  }
                ...
                Flexible(
                  ...
                  child: TextFormField(
                    decoration: const InputDecoration(
                        ...
                        labelStyle: TextStyle(color: tanteLadenIconBrown)),
                ...
                Flexible(
                  ...
                  child: TextFormField(
                    ...
                    onEditingComplete: () {
                      ...
                      debugPrint('El valor de: _categoryId es: $_categoryId');
                    },
              ...
              children: <Widget>[
                Flexible(
                    ...
                    child: TextFormField(
                      ...
                      autovalidateMode: AutovalidateMode.onUserInteraction,
                      onEditingComplete: () {
                        _productPrice = double.tryParse(_productPriceController
                            .text
                            .replaceAll(RegExp(','), '.'))!;
                        debugPrint(
                            'El valor de: productPrice es: $_productPrice');
                      },
                      validator: (String? value) {
                    ...
                    child: ListTile(
                      ...
                      leading: Radio<PriceChangeType>(
                        ...
                        onChanged: (PriceChangeType? value) {
                          ...
                          _valueDiscountController.text = NumberFormat(
                                  '##0.00', 'es_ES')
              ...
              children: <Widget>[
                Flexible(
                  ...
                  child: DropdownButtonFormField(
                    decoration: InputDecoration(
                      enabledBorder: OutlineInputBorder(
                        borderSide: const BorderSide(
                            color: tanteLadenAmber100, width: 2),
                    ...
                    items: widget.data.taxTypeItems
                        .map<DropdownMenuItem<String>>((TaxType value) {
              ...
              children: <Widget>[
                Flexible(
                  ...
                  child: DropdownButtonFormField(
                    ...
                    items: widget.data.unitTypeItems
              ...
              children: <Widget>[
                Flexible(
                  ...
                  child: DropdownButtonFormField(
                    ...
                    items: widget.data.productTypeItems
                        .map<DropdownMenuItem<String>>((ProductType value) {
                      return DropdownMenuItem<String>(
              ...
              children: <Widget>[
                Flexible(
                  ...
                  child: DropdownButtonFormField(
                    ...
                    items: widget.data.providerItems
                        .map<DropdownMenuItem<String>>((ProviderProduct value) {
                      return DropdownMenuItem<String>(
              ...
              children: <Widget>[
                Flexible(
                  ...
                  child: TextFormField(
                    ...
                    onEditingComplete: () {
                      _weekWarning =
                          int.tryParse(_weeksWarningController.text)!;
                      debugPrint('El valor de: _weekWarning es: $_weekWarning');
                    },
                    validator: (String? value) {
              ...
              children: <Widget>[
                Flexible(
                  ...
                  child: TextFormField(
                    ...
                    onEditingComplete: () {
                      _quantityMinPrice =
                          int.tryParse(_quantityMinPriceController.text)!;
                    },
                    validator: (String? value) {
                      RegExp regexp = RegExp(r'^[0-9]{1,6}$');
                      if (!regexp.hasMatch(value ?? "") || value == null) {
              ...
              children: <Widget>[
                Flexible(
                  ...
                  child: TextFormField(
                    ...
                    onEditingComplete: () {
                      _quantityMaxPrice =
                          int.tryParse(_quantityMaxPriceController.text)!;
                    },
                    validator: (String? value) {
                      RegExp regexp = RegExp(r'^[0-9]{1,6}$');
                      if (!regexp.hasMatch(value ?? "") || value == null) {
                  ...
                  GestureDetector(
                      ...
                      onTap: () async {
                        try {
                          ...
                          payload = json.decode(utf8.decode(base64
                              .decode(base64.normalize(token.split(".")[1]))));
                          final String partnerId =
                              payload['partner_id'].toString();
                          final String partnerName =
                              payload['partner_name'].toString();
...
class _MediumScreenView extends StatefulWidget {
  final NewProductData data;
  final NewProductService service;
  const _MediumScreenView(this.data, this.service);
  @override
...
class _LargeScreenView extends StatefulWidget {
  final NewProductData data;
  final NewProductService service;
  const _LargeScreenView(this.data, this.service);
  @override
