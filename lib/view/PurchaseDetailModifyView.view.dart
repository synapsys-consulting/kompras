...
class PurchaseDetailModifyView extends StatefulWidget {
  ...
  const PurchaseDetailModifyView(
      this.userId, this.grandFather, this.partnerId, this.father, this.userRole,
      {super.key});
  @override
...
class PurchaseDetailModifyViewState extends State<PurchaseDetailModifyView> {
  final PurchaseDetailModifyController _controller =
      PurchaseDetailModifyController();
...
class _SmallScreen extends StatefulWidget {
  ...
  final int partnerId;
  final String userRole;
  const _SmallScreen(this.father, this.productItem, this.userId,
      this.stateChanged, this.partnerId, this.userRole);
  @override
...
class _SmallScreenState extends State<_SmallScreen> {
  ...
  final TextEditingController _percentDiscountTextField =
      TextEditingController();
  final TextEditingController _valueDiscountTextFieldOnlyForCaseOne =
      TextEditingController(); // Use a new text controller only for modifying the price text field of the case 1
  final TextEditingController _percentDiscountTextFieldOnlyForCaseOne =
      TextEditingController(); // Use a new text controller only for modifying the price text field of the case 1
  ...
  double _newNumItemsPurchased =
      0; // save the value of the field NEW_QUANTITY of the KRC_PURCHASE table.
  late double
      _newNewProductPriceFinal; // save the value of the field NEW_PRODUCT_PRICE_FINAL of the KRC_PURCHASE table.
  late double
      _newPrice; // save the value of the field PRODUCT_PRICE of the KRC_PURCHASE table.
  ...
  void _valueDiscountTextFieldProcessor() {
    ...
    if (widget.father.newProductPrice != -1) {
      ...
      if (widget.father.newQuantity != -1) {
        _valueDiscount = double.tryParse(
            _valueDiscountTextField.text.replaceFirst(RegExp(','), '.'))!;
        debugPrint(
            'Estoy en el listener. El valor de _valueDiscount es: $_valueDiscount');
        ...
        debugPrint(
            'Valor de _valueDiscountTextField.text: ${_valueDiscountTextField.text}');
        _totalBeforeDiscountWithoutTax =
            widget.father.newQuantity * widget.father.productPrice;
        debugPrint(
            'El valor de _totalBeforeDiscountWithoutTax es: $_totalBeforeDiscountWithoutTax');
        _totalBeforeDiscount = widget.father.newQuantity *
            (widget.father.productPrice *
                (1 + widget.productItem.taxApply / 100));
        debugPrint(
            'El valor de _totalBeforeDiscount es: $_totalBeforeDiscount');
        final double productPriceDiscounted = (widget.father.newProductPrice +
            (_valueDiscount *
                MULTIPLYING_FACTOR)); // product price minus discount
        debugPrint(
            'El valor de productPriceDiscounted es: $productPriceDiscounted');
        setState(() {
          _newNewProductPriceFinal = productPriceDiscounted;
        });
        _discountAmount = widget.father.newQuantity *
            ((_newNewProductPriceFinal - widget.father.productPrice));
        debugPrint('El valor de _discountAmount es: $_discountAmount');
        _totalAfterDiscountWithoutTax =
            widget.father.newQuantity * _newNewProductPriceFinal;
        debugPrint(
            'El valor de _totalAfterDiscountWithoutTax es: $_totalAfterDiscountWithoutTax');
        final double taxAmountByProduct =
            productPriceDiscounted * (widget.productItem.taxApply / 100);
        ...
        debugPrint(
            'Valor de _valueDiscountTextField.text: ${_valueDiscountTextField.text}');
        _totalBeforeDiscountWithoutTax =
            widget.productItem.purchased * widget.father.productPrice;
        debugPrint(
            'El valor de _totalBeforeDiscountWithoutTax es: $_totalBeforeDiscountWithoutTax');
        _totalBeforeDiscount = widget.productItem.purchased *
            (widget.father.productPrice *
                (1 + widget.productItem.taxApply / 100));
        debugPrint(
            'El valor de _totalBeforeDiscount es: $_totalBeforeDiscount');
        ...
        _discountAmount = widget.productItem.purchased *
            ((_newNewProductPriceFinal - widget.father.productPrice));
        debugPrint('El valor de _discountAmount es: $_discountAmount');
        _totalAfterDiscountWithoutTax =
            widget.productItem.purchased * _newNewProductPriceFinal;
        debugPrint(
            'El valor de _totalAfterDiscountWithoutTax es: $_totalAfterDiscountWithoutTax');
        final double taxAmountByProduct =
            productPriceDiscounted * (widget.productItem.taxApply / 100);
      ...
      if (widget.father.newQuantity != -1) {
        ...
        debugPrint(
            'El valor de _totalBeforeDiscount es: $_totalBeforeDiscount');
        final double productPriceDiscounted = (widget.father.productPrice +
            (_valueDiscount *
                MULTIPLYING_FACTOR)); // product price minus discount
        debugPrint(
            'El valor de productPriceDiscounted es: $productPriceDiscounted');
  ...
  void _percentDiscountTextFieldProcessor() {
    ...
    if (widget.father.newProductPrice != -1) {
      ...
      if (widget.father.newQuantity != -1) {
        debugPrint(
            'Valor de _percentDiscountTextField.text: ${_percentDiscountTextField.text}');
        // the price has been previously modified
        _percentDiscount = double.tryParse(
            _percentDiscountTextField.text.replaceFirst(RegExp(','), '.'))!;
        ...
        debugPrint(
            'El valor de _totalBeforeDiscount es: $_totalBeforeDiscount');
        final double productPriceDiscounted = widget.father.newProductPrice *
            (1 + (_percentDiscount / 100)); // product price minus discount
        debugPrint(
            'El valor de productPriceDiscounted es: $productPriceDiscounted');
        setState(() {
          _newNewProductPriceFinal = productPriceDiscounted;
  ...
  void _valueDiscountTextFieldForCaseOneProcessor() {
    ...
    debugPrint(
        'Estoy en el listener _valueDiscountTextFieldForCaseOneProcessor');
    if (widget.father.newProductPrice != -1) {
      if (widget.father.newQuantity != -1) {
        debugPrint('Estoy en el _newNewProductPriceFinal != -1');
        // the price has been previously modified
        _valueDiscount = double.tryParse(_valueDiscountTextFieldOnlyForCaseOne
            .text
            .replaceFirst(RegExp(','), '.'))!;
        debugPrint(
            'Estoy en el listener. El valor de _valueDiscount es: $_valueDiscount');
        ...
        // There is a change in the price
        debugPrint(
            'Valor de _valueDiscountTextFieldOnlyForCaseOne.text: ${_valueDiscountTextFieldOnlyForCaseOne.text}');
        _totalBeforeDiscountWithoutTax =
            _newNumItemsPurchased * widget.father.productPrice;
        debugPrint(
            'El valor de _totalBeforeDiscountWithoutTax es: $_totalBeforeDiscountWithoutTax');
        _totalBeforeDiscount = _newNumItemsPurchased *
            (widget.father.productPrice *
                (1 + widget.productItem.taxApply / 100));
        debugPrint(
            'El valor de _totalBeforeDiscount es: $_totalBeforeDiscount');
        ...
        _discountAmount = _newNumItemsPurchased *
            ((_newNewProductPriceFinal - widget.father.productPrice));
        debugPrint('El valor de _discountAmount es: $_discountAmount');
        _totalAfterDiscountWithoutTax =
            _newNumItemsPurchased * _newNewProductPriceFinal;
        debugPrint(
            'El valor de _totalAfterDiscountWithoutTax es: $_totalAfterDiscountWithoutTax');
        final double taxAmountByProduct =
            productPriceDiscounted * (widget.productItem.taxApply / 100);
  ...
  void _percentDiscountTextFieldForCaseOneProcessor() {
    // Use a new and different listener for the case 1 (Price and Amount modified)
    debugPrint(
        'Estoy en el listener _percentDiscountTextFieldForCaseOneProcessor.');
    if (widget.father.newProductPrice != -1) {
      if (widget.father.newQuantity != -1) {
        debugPrint('Estoy en el _newNewProductPriceFinal != -1');
        debugPrint(
            'Valor de _percentDiscountTextFieldOnlyForCaseOne.text: ${_percentDiscountTextFieldOnlyForCaseOne.text}');
        // the price has been previously modified
        _percentDiscount = double.tryParse(
            _percentDiscountTextFieldOnlyForCaseOne.text
                .replaceFirst(RegExp(','), '.'))!;
        debugPrint('El valor de _percentDiscount es: $_valueDiscount');
        _totalBeforeDiscountWithoutTax =
            _newNumItemsPurchased * widget.father.productPrice;
      ...
      if (widget.father.newQuantity != -1) {
        ...
        _percentDiscount = double.tryParse(
            _percentDiscountTextFieldOnlyForCaseOne.text
                .replaceFirst(RegExp(','), '.'))!;
        debugPrint(
            'Valor de _percentDiscountTextField.text: ${_percentDiscountTextFieldOnlyForCaseOne.text}');
        _totalBeforeDiscountWithoutTax =
            _newNumItemsPurchased * widget.father.productPrice;
        debugPrint(
            'El valor de _totalBeforeDiscountWithoutTax es: $_totalBeforeDiscountWithoutTax');
  ...
  void initState() {
    ...
    _totalBeforeDiscountWithoutTax =
        widget.father.totalBeforeDiscountWithoutTax;
    _valueDiscount = 0.0;
    _valueDiscountTextField.text = NumberFormat('##0.00', 'es_ES')
        .format(double.parse(_valueDiscount.toString()));
    _valueDiscountTextFieldOnlyForCaseOne.text = NumberFormat('##0.00', 'es_ES')
        .format(double.parse(_valueDiscount.toString()));
    _percentDiscount = 0.0;
    _newNewProductPriceFinal = widget.father.newProductPrice;
    _newPrice = widget.father.productPrice;
    debugPrint(
        'El valor de _newNewProductPriceFinal es: $_newNewProductPriceFinal');
    _percentDiscountTextField.text = NumberFormat('##0.00', 'es_ES')
        .format(double.parse(_percentDiscount.toString()));
    _percentDiscountTextFieldOnlyForCaseOne.text =
        NumberFormat('##0.00', 'es_ES')
            .format(double.parse(_percentDiscount.toString()));
    _totalBeforeDiscountWithoutTax =
        widget.father.totalBeforeDiscountWithoutTax;
    ...
    _valueDiscountTextFieldOnlyForCaseOne.addListener(
        _valueDiscountTextFieldForCaseOneProcessor); // Use a new and different listener for the case 1 (Price and Amount modified)
    _percentDiscountTextFieldOnlyForCaseOne.addListener(
        _percentDiscountTextFieldForCaseOneProcessor); // Use a new and different listener for the case 1 (Price and Amount modified)
  }
            ...
            GestureDetector(
              child: Container(
                ...
                child: const Text(
                  'Modificar pedido',
                  style: TextStyle(
                      fontSize: 24.0, color: tanteLadenBackgroundWhite),
                ),
              ),
              onTap: () async {
                try {
                  ...
                  if (widget.father.banQuantity == "SI" &&
                      widget.father.banPrice == "SI") {
                    // Case 1
                    // The price and the quantity of the purchased has been changed by the user
                    if (_valueDiscount != 0 ||
                        _percentDiscount != 0 ||
                        _newNumItemsPurchased !=
                            widget.father.newProductPrice ||
                        widget.productItem.purchased != widget.father.items) {
                      // There is a modification
                      debugPrint('Entro en el caso 1.');
                      debugPrint(
                          'El valor de _valueDiscountTextField es: ${_valueDiscountTextField.text}');
                      debugPrint(
                          'El valor de _percentDiscountTextField es: ${_percentDiscountTextField.text}');
                      final Uri url = Uri.parse(
                          '$SERVER_IP/modifyPurchaseLine/${widget.father.orderId}/${widget.father.providerName}');
                      ...
                      final http.Response res = await http.put(url,
                          ...
                          body: jsonEncode(<String, String>{
                            ...
                            'new_purchased': _newNumItemsPurchased != -1
                                ? _newNumItemsPurchased.toString()
                                : (widget.productItem.purchased !=
                                        widget.father.items
                                    ? widget.productItem.purchased.toString()
                                    : null)!,
                            'new_product_price': (_newNewProductPriceFinal != -1
                                ? _newNewProductPriceFinal.toString()
                                : null)!,
                            'total_before_discount':
                                _totalBeforeDiscount.toString(),
                            ...
                            'case_to_apply':
                                '1', // Case 1. he price and the quantity of the purchased has been changed
                            'comment': _comment
                          }));
                      ...
                      if (res.statusCode == 200) {
                        ...
                        final List<Map<String, dynamic>> resultListJson = json
                            .decode(res.body)['statusToTransitionTo']
                            .cast<Map<String, dynamic>>();
                        debugPrint('Entre medias de la api RESPONSE.');
                        final List<PurchaseStatus>
                            resultListPurchaseStatusToTransitionTo =
                            resultListJson
                                .map<PurchaseStatus>(
                                    (json) => PurchaseStatus.fromJson(json))
                                .toList();
                        if (resultListPurchaseStatusToTransitionTo.isNotEmpty) {
                          widget.father.possibleStatusToTransitionTo.clear();
                          for (var element
                              in resultListPurchaseStatusToTransitionTo) {
                            debugPrint(
                                'El valor de statusName es: ${element.statusName}');
                            debugPrint(
                                'El valor de BAN_PRICE es: ${element.banPrice}');
                            debugPrint(
                                'El valor de BAN_QUANTITY es: ${element.banQuantity}');
                            widget.father.possibleStatusToTransitionTo
                                .add(element);
                          }
                        }
                        debugPrint(
                            'Despues de retornar los statusToTransitionTo.');
                        // get the values of BAN_PRICE and BAN_QUANTITY among the new state of the modified purchased line, "O" (OBSERVACIONES)
                        final List<Map<String, dynamic>> anotherResultListJson =
                            json
                                .decode(res.body)['currentBanQuantityBanPrice']
                                .cast<Map<String, dynamic>>();
                        debugPrint('Entre medias de la api RESPONSE.');
                        final List<PurchaseStatus>
                            currentBanPriceBanStatusValues =
                            anotherResultListJson
                                .map<PurchaseStatus>(
                                    (json) => PurchaseStatus.fromJson(json))
                                .toList();
                        if (currentBanPriceBanStatusValues.isNotEmpty) {
                          widget.father.banQuantity =
                              currentBanPriceBanStatusValues[0].banQuantity;
                          widget.father.banPrice =
                              currentBanPriceBanStatusValues[0].banPrice;
                        }
                        debugPrint(
                            'Despues de retornar los currentBanPriceBanStatusValues.');
                        widget.stateChanged.changed = true;
                        widget.father.newQuantity = _newNumItemsPurchased != -1
                            ? _newNumItemsPurchased
                            : (widget.productItem.purchased !=
                                    widget.father.items
                                ? widget.productItem.purchased
                        ...
                        widget.father.newProductPrice =
                            _newNewProductPriceFinal != -1
                                ? _newNewProductPriceFinal
                                : widget.father.newProductPrice;
                        debugPrint(
                            'El valor de widget.father.newProductPrice es: ${widget.father.newProductPrice}');
                        widget.father.totalBeforeDiscountWithoutTax =
                            _totalBeforeDiscountWithoutTax;
                        widget.father.discountAmount = _discountAmount;
                        widget.father.totalAfterDiscountWithoutTax =
                            _totalAfterDiscountWithoutTax;
                  ...
                  } else if (widget.father.banQuantity == "NO" &&
                      widget.father.banPrice == "SI") {
                    // Case 2
                    ...
                    final http.Response res = await http.put(url,
                        ...
                        body: jsonEncode(<String, String>{
                          ...
                          'is_official': _isOfficial.toString(),
                          'case_to_apply':
                              '2', // Only the price of the purchased has been changed by the user
                          'comment': _comment
                        }));
                    _showPleaseWait(false);
                    if (res.statusCode == 200) {
                      ...
                      debugPrint('Entre medias de la api RESPONSE.');
                      final List<PurchaseStatus>
                          currentBanPriceBanStatusValues = anotherResultListJson
                              .map<PurchaseStatus>(
                                  (json) => PurchaseStatus.fromJson(json))
                              .toList();
                      if (currentBanPriceBanStatusValues.isNotEmpty) {
                      ...
                      ShowSnackBar.showSnackBar(
                          context, json.decode(res.body)['message'].toString());
                    }
                  } else if (widget.father.banQuantity == "SI" &&
                      widget.father.banPrice == "NO") {
                    // Case 3
                      ...
                      if (_newNumItemsPurchased != widget.father.newQuantity) {
                        ...
                        final http.Response res = await http.put(url,
                            ...
                            body: jsonEncode(<String, String>{
                              ...
                              'tax_amount': _taxAmount.toString(),
                              'case_to_apply':
                                  '3', // Only the quantity has been changed by the user
                              'comment': _comment
                            }));
                        _showPleaseWait(false);
                        if (res.statusCode == 200) {
                          ...
                          final List<PurchaseStatus>
                              ...
                              resultListJson
                                  .map<PurchaseStatus>(
                                      (json) => PurchaseStatus.fromJson(json))
                                  .toList();
                          if (resultListPurchaseStatusToTransitionTo
                              .isNotEmpty) {
                            widget.father.possibleStatusToTransitionTo.clear();
                            for (var element
                                in resultListPurchaseStatusToTransitionTo) {
                          ...
                          final List<Map<String, dynamic>>
                              anotherResultListJson = json
                                  .decode(
                                      res.body)['currentBanQuantityBanPrice']
                                  .cast<Map<String, dynamic>>();
                          debugPrint('Entre medias de la api RESPONSE.');
                          final List<PurchaseStatus>
                              currentBanPriceBanStatusValues =
                          ...
                          debugPrint(
                              "El valor de widget.father.newQuantity es: ${widget.father.newQuantity}");
                          widget.father.totalBeforeDiscountWithoutTax =
                              _totalBeforeDiscountWithoutTax;
                          widget.father.discountAmount = _discountAmount;
                          widget.father.totalAfterDiscountWithoutTax =
                      ...
                      if (widget.father.items != widget.productItem.purchased) {
                        ...
                        final http.Response res = await http.put(url,
                            ...
                            body: jsonEncode(<String, String>{
                              ...
                              'user_id': widget.userId.toString(),
                              'user_role': widget.userRole.toString(),
                              'new_purchased': (widget.productItem.purchased !=
                                      widget.father.items
                                  ? widget.productItem.purchased.toString()
                                  : null)!,
                              'total_before_discount':
      ...
      return SafeArea(child: LayoutBuilder(
        builder: (context, constraints) {
          ...
          for (var i = 0; i < widget.productItem.numImages; i++) {
            listImagesProduct.add(
                '$SERVER_IP$IMAGES_DIRECTORY${widget.productItem.productCode}_$i.gif');
          }
          return ListView(
            children: [
              widget.productItem.numImages > 1
                  ? Column(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        CarouselSlider(
                          items: listImagesProduct
                              .map((url) => AspectRatio(
                                    aspectRatio: 3.0 / 2.0,
                      ...
                      child: AspectRatio(
                        ...
                        child: CachedNetworkImage(
                          placeholder: (context, url) =>
                              const CircularProgressIndicator(),
                          imageUrl:
                              '$SERVER_IP$IMAGES_DIRECTORY${widget.productItem.productCode}_0.gif',
                          fit: BoxFit.scaleDown,
                          errorWidget: (context, url, error) =>
                              const Icon(Icons.error),
                        ),
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: widget.father.newProductPrice != -1
                          ? Text.rich(TextSpan(
                              ...
                              children: <TextSpan>[
                                  TextSpan(
                                      text:
                                          '${' (${NumberFormat("##0.00", "es_ES").format(double.parse((widget.father.productPrice / MULTIPLYING_FACTOR).toString()))}'})',
                                      style: const TextStyle(
                                        fontWeight: FontWeight.w500,
                                        fontSize: 30.0,
                                        fontFamily: 'SF Pro Display',
                ...
                children: [
                  TextButton(
                        ...
                        if (_newNumItemsPurchased != -1) {
                          ...
                          if (widget.father.newProductPrice != -1) {
                            if (_newNumItemsPurchased > 0) {
                              setState(() {
                                _newNumItemsPurchased = _newNumItemsPurchased -
                                    widget.productItem.minQuantitySell;
                                if (_newNumItemsPurchased < 0)
                                  _newNumItemsPurchased = 0;
                              });
                              _totalBeforeDiscountWithoutTax =
                                  _newNumItemsPurchased *
                                      widget.father.productPrice;
                              ...
                              _discountAmount = _newNumItemsPurchased *
                                  ((_newNewProductPriceFinal -
                                      widget.father.productPrice));
                              debugPrint(
                                  'El valor de _discountAmount es: $_discountAmount');
                              _totalAfterDiscountWithoutTax =
                                  _newNumItemsPurchased *
                                      _newNewProductPriceFinal;
                              debugPrint(
                                  'El valor de _totalAfterDiscountWithoutTax es: $_totalAfterDiscountWithoutTax');
                              _taxAmount = _newNumItemsPurchased *
                                  (_newNewProductPriceFinal *
                                      (widget.productItem.taxApply / 100));
                              debugPrint(
                                  'El valor de _taxAmount es: $_taxAmount');
                              _totalAmount =
                                  _totalAfterDiscountWithoutTax + _taxAmount;
                              debugPrint(
                                  'El valor de _totalAmount es: $_totalAmount');
                            }
                          } else {
                            if (_newNumItemsPurchased > 0) {
                              setState(() {
                              ...
                              _discountAmount =
                                  0; // If widget.father.newProductPrice means that there si no discount
                              debugPrint(
                                  'El valor de _discountAmount es: $_discountAmount');
                              _totalAfterDiscountWithoutTax =
                                  _newNumItemsPurchased *
                          ...
                          if (widget.father.newProductPrice != -1) {
                            if (widget.productItem.purchased > 0) {
                              setState(() {
                                widget.productItem.purchased =
                                    widget.productItem.purchased -
                                        widget.productItem.minQuantitySell;
                                if (widget.productItem.purchased < 0)
                                  widget.productItem.purchased = 0;
                              });
                              _totalBeforeDiscountWithoutTax =
                                  widget.productItem.purchased *
                                      widget.father.productPrice;
                              ...
                              debugPrint(
                                  'El valor de _totalAfterDiscountWithoutTax es: $_totalAfterDiscountWithoutTax');
                              _taxAmount = widget.productItem.purchased *
                                  (_newNewProductPriceFinal *
                                      (widget.productItem.taxApply / 100));
                              debugPrint(
                                  'El valor de _taxAmount es: $_taxAmount');
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            shape: BoxShape.circle,
                            border: Border.all(
                                color: tanteLadenButtonBorderGray, width: 1)),
                        child: Container(
                          width: 40.0,
                          height: 40.0,
                          alignment: Alignment.center,
                  ...
                  Padding(
                    ...
                    padding: const EdgeInsets.only(
                        left: WithInDpis_20, right: WithInDpis_20),
                    child: RichText(
                        text: TextSpan(
                          ...
                          TextSpan(
                              text: widget.father.newQuantity != -1
                                  ? _newNumItemsPurchased > 1
                                      ? ' ${widget.productItem.idUnit}s.'
                                      : ' ${widget.productItem.idUnit}.'
                                  : widget.productItem.purchased > 1
                                      ? ' ${widget.productItem.idUnit}s.'
                                      : ' ${widget.productItem.idUnit}.',
                              style:
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.only(right: 15.0),
                      child: _newNewProductPriceFinal != -1
                          ? Text.rich(TextSpan(
                              text: NumberFormat.currency(
                                      locale: 'es_ES',
                                      symbol: '€',
                      ...
                      child: ListTile(
                        ...
                        leading: Radio<PriceChangeType>(
                          ...
                          onChanged: (PriceChangeType? value) {
                            ...
                            _valueDiscountTextField.text =
                                NumberFormat('##0.00', 'es_ES').format(
                                    double.parse(_valueDiscount.toString()));
                            _percentDiscountTextField.text =
                                NumberFormat('##0.00', 'es_ES').format(
                                    double.parse(_percentDiscount.toString()));
                          },
                        ),
                      )),
                  Expanded(
                                ...
                                child: TextButton(
                                    onPressed: () {
                                      ...
                                      if (widget.father.newProductPrice != -1) {
                                        // the price has been previously modified
                                        debugPrint(
                                            'Estoy en el onPressed de -. Dentro de la parte de que el precio ha sido previamente modificado.');
                                        final double tmpValueDiscount =
                                            _valueDiscount;
                                        _valueDiscount = _valueDiscount - 0.1;
                                        if (widget.father.newProductPrice >=
                                            (_valueDiscount *
                                                    MULTIPLYING_FACTOR)
                                                .abs()) {
                                        ...
                                        //debugPrint ('Estoy en el que el precio aún no ha sido modificado nunca');
                                        debugPrint(
                                            'Estoy en el onPressed de -. Dentro de la parte de que el precio nunca ha sido previamente modificado.');
                                        final double tmpValueDiscount =
                                            _valueDiscount;
                                        _valueDiscount = _valueDiscount - 0.1;
                                        debugPrint(
                                            'El valor de _valueDiscount es: $_valueDiscount');
                                        if (widget.father.productPrice >=
                                            (_valueDiscount *
                                                    MULTIPLYING_FACTOR)
                                                .abs()) {
                                          // the price can't be negative
                                ...
                                child: TextButton(
                                    onPressed: () {
                                      if (widget.father.newProductPrice != -1) {
                                        ...
                                        debugPrint(
                                            'Estoy en el onPressed de -. Dentro de la parte de que el precio ha sido previamente modificado.');
                                        final double tmpPercentDiscount =
                                            _percentDiscount;
                                        _percentDiscount =
                                            _percentDiscount - 0.5;
                                        debugPrint(
                                            'El valor de _percentDiscount es: $_percentDiscount');
                                        debugPrint(
                                            'El valor de productPrice es: ${widget.father.productPrice}');
                                        debugPrint(
                                            'El valor de widget.father.productPrice * (1+(_percentDiscount/100)) es: ${((widget.father.productPrice * (1 + (_percentDiscount / 100)))).abs()}');
                                        if (widget.father.newProductPrice >=
                                            ((widget.father.newProductPrice *
                                                    (1 +
                                                        (_percentDiscount /
                        ...
                        if (widget.father.newQuantity != -1) {
                          ...
                          if (_newNewProductPriceFinal != -1) {
                            if (_newNumItemsPurchased > 0) {
                              ...
                              debugPrint(
                                  'El valor de _totalBeforeDiscount es: $_totalBeforeDiscount');
                              final double productPriceDiscounted =
                                  (_newNewProductPriceFinal +
                                      (_valueDiscount *
                                          MULTIPLYING_FACTOR)); // product price minus discount
                              debugPrint(
                              ...
                              final double taxAmountByProduct =
                                  productPriceDiscounted *
                                      (widget.productItem.taxApply / 100);
                              debugPrint(
                                  'El valor de taxAmountByProduct es: $taxAmountByProduct');
                              _taxAmount =
                                  _newNumItemsPurchased * taxAmountByProduct;
                              debugPrint(
                                  'El valor de _taxAmount es: $_taxAmount');
                              _totalAmount =
                                  _totalAfterDiscountWithoutTax + _taxAmount;
                            ...
                            if (_newNumItemsPurchased > 0) {
                              ...
                              debugPrint(
                                  'El valor de _totalBeforeDiscount es: $_totalBeforeDiscount');
                              final double productPriceDiscounted = (widget
                                      .father.productPrice +
                                  (_valueDiscount *
                                      MULTIPLYING_FACTOR)); // product price minus discount
                              _discountAmount = _newNumItemsPurchased *
                      ...
                      child: ListTile(
                        ...
                        leading: Radio<PriceChangeType>(
                          ...
                          onChanged: (PriceChangeType? value) {
                            ...
                            _valueDiscountTextFieldOnlyForCaseOne.text =
                                NumberFormat('##0.00', 'es_ES').format(
                                    double.parse(_valueDiscount.toString()));
                            _percentDiscountTextFieldOnlyForCaseOne.text =
                                NumberFormat('##0.00', 'es_ES').format(
                                    ...
                                    onPressed: () {
                                      ...
                                      if (widget.father.newProductPrice != -1) {
                                        ...
                                        if (widget.father.newProductPrice >=
                                          ...
                                          // the price can't be negative
                                          setState(() {
                                            _valueDiscountTextFieldOnlyForCaseOne
                                                .text = NumberFormat(
                                                    '##0.00', 'es_ES')
                                                .format(double.parse(
                                ...
                                child: TextButton(
                                    onPressed: () {
                                      setState(() {
                                        _percentDiscount =
                                            _percentDiscount - 0.5;
                                        _percentDiscountTextFieldOnlyForCaseOne
                                            .text = NumberFormat(
                                                '##0.00', 'es_ES')
                                            .format(double.parse(
                                                (_percentDiscount).toString()));
                                      });
                                      // There is a change in the price
                                      _totalBeforeDiscountWithoutTax =
                                          widget.productItem.purchased *
                                      ...
                                      _totalBeforeDiscount = widget
                                          ...
                                          (widget.father.productPrice *
                                              (1 +
                                                  widget.productItem.taxApply /
                                                      100));
                                      final double productPriceDiscounted = widget
                                              .father.productPrice *
                                          (1 -
                                              (_percentDiscount /
                                                  100)); // product price minus discount
                                      _discountAmount =
                                          widget.productItem.purchased *
                                              (widget.father.productPrice *
...
class _MediumScreen extends StatefulWidget {
  ...
  final int partnerId;
  final String userRole;
  const _MediumScreen(this.father, this.productItem, this.userId,
      this.stateChanged, this.partnerId, this.userRole);
  @override
...
class _LargeScreen extends StatefulWidget {
  ...
  final int partnerId;
  final String userRole;
  const _LargeScreen(this.father, this.productItem, this.userId,
      this.stateChanged, this.partnerId, this.userRole);
  @override
