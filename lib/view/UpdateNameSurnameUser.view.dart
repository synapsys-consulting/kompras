...
class UpdateNameSurnameUser extends StatefulWidget {
  ...
  final int userId;
  const UpdateNameSurnameUser(this.firstName, this.lastName, this.userId,
      {super.key});
...
class _UpdateNameSurnameUserState extends State<UpdateNameSurnameUser> {
  ...
  void initState() {
    ...
    _pleaseWait = false;
    _firstNameIn =
        widget.firstName; // Save the value that come as the input parameter
    _lastNameIn =
        widget.lastName; // Save the value that come as the input parameter
  }
        ...
        onPressed: () async {
          try {
            ...
            final Uri url = Uri.parse(
                '$SERVER_IP/updateUserWithPersoneId/${widget.userId}');
            ...
            if (res.statusCode == 200) {
              ...
              Navigator.pop(
                  context, '${_nameOut.name} ${_surnameOut.surNames}');
            } else {
              _showPleaseWait(false);
            }
          } catch (e) {
    ...
    return Scaffold(
      ...
      body: ResponsiveWidget(
        smallScreen: _SmallScreenView(
            widget.firstName, widget.lastName, _nameOut, _surnameOut),
...
class _SmallScreenView extends StatefulWidget {
  const _SmallScreenView(
      this.name, this.surNames, this.nameOut, this.surnameOut);
  final String name;
