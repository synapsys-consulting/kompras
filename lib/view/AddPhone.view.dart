...
class _AddPhoneState extends State<AddPhone> {
  ...
  void initState() {
    ...
    _pleaseWait = false;
    _phoneIn =
        widget.phoneNumber; // Save the value that come as the input parameter
  }
      ...
      child: TextButton(
        ...
        onPressed: () async {
          try {
            ...
            debugPrint(
                'El valor del número de teléfono es: ${_phoneOut.number}');
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.pop(context,
                _phoneIn); // if click on the <- of the AppBar return the same phone that came
          },
        ),
        title: const Text(
          'Cambiar teléfono',
...
class _SmallScreenViewState extends State<_SmallScreenView> {
  ...
  void initState() {
    ...
    if (widget.phoneNumber == 'null') {
      // True: The user has still a phone number. False: The user don't have a phone number yet.
